export default defineComponent(({ name, schema, template }) => {
	name('chaosgui:endergirl_mentality')
	schema({
	...
	template(({ default_embarrasment, sex, masturbation, default_stability, aquaphobia, painful_sex, mutilation }) => ({
		"minecraft:dynamic_property": {
			...
			"chaosgui:aquaphobia": aquaphobia,
